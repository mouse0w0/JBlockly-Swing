...
public class JBlockInsertSlot extends JPanel{
	...
	public void doLayout() {
		...
		setPreferredSize(new Dimension(insert!=null?insert.getPreferredSize().width+2:40,insert!=null?insert.getPreferredSize().height+2:27));
		setSize(insert!=null?insert.getPreferredSize().width+2:40,insert!=null?insert.getPreferredSize().height+2:27);
	}
	
	@Override
	protected void paintComponent(Graphics g) {
		Color light=new Color(54,85,168),
				dark=new Color(108,138,223),
